...
describe("POST /companies", function () {
  ...
  test("As admin: bad request with missing data", async function () {
    const resp = await request(app)
      .post("/companies")
      .send({
        handle: "new",
  ...
  test("As admin: bad request with invalid data", async function () {
    const resp = await request(app)
      .post("/companies")
      .send({
        ...newCompany,
...
describe("PATCH /companies/:handle", function () {
  ...
  test("As admin: not found on no such company", async function () {
    const resp = await request(app)
  ...
  test("As admin: bad request on handle change attempt", async function () {
    const resp = await request(app)
      .patch(`/companies/c1`)
      .send({
        handle: "c1-new",
  ...
  test("As admin: bad request on invalid data", async function () {
    const resp = await request(app)
      .patch(`/companies/c1`)
      .send({
        logoUrl: "not-a-url",
...
describe("DELETE /companies/:handle", function () {
  ...
  test("As admin: not found for no such company", async function () {
    const resp = await request(app)
